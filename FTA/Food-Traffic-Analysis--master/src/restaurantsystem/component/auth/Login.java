...
import restaurantsystem.service.DbConnection;
...
public class Login extends javax.swing.JFrame {
    ...
    int flag = 0; //1 for login successful 0 for unsuccessful login
// SQL Connection 
        ...
        try (Connection conn = DbConnection.connect();
             ...
             ResultSet rs = stmt.executeQuery(sql)){
                 ...
                 while(rs.next()){
                     ...
                     if ((userNameField.getText().equalsIgnoreCase(dbUsername)) && (passwordField.getText().equalsIgnoreCase(dbPassword))) {
                        JOptionPane.showMessageDialog(this, "Access granted");
                        System.out.println("Log: username - " + userNameField.getText() + " has logged in" );
                        flag = 1;
                        this.dispose();
