...
public class AddItem extends javax.swing.JFrame {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if((name.isEmpty()) && ((price.isEmpty() || !price.chars().allMatch( Character::isDigit))) && (quantity.isEmpty() || !quantity.chars().allMatch( Character::isDigit))) {
            JOptionPane.showMessageDialog(this, "Something is wrong with the input. Please check again?");
            return;
        }
        ...
        try (Connection conn = connect();
            ...
            pstmt.setInt(3, parseInt(quantity));
